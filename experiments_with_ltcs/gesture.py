...
class GestureModel:
    ...
    def __init__(self,model_type,model_size,learning_rate = 0.001,batch_size=16,
        ...
        self.y = tf.layers.Dense(5, activation=None, name="dense_readout")(masked_state)
        ...
        self.train_step = optimizer.minimize(self.loss, var_list=[v for v in tf.trainable_variables() if "W_in" in v.name or "dense" in v.name]) if model_type in ("srnn-echo", "srnn-e-only-echo") else optimizer.minimize(self.loss)
        ...
        for e in range(epochs):
            ...
            if(e > 0 and e % 10 == 0):
                ...
                run_lyapunov_if_due(
                    ...
                    gesture_data.valid_x, os.path.join("lyapunov", "gesture"),
...
if __name__ == "__main__":
    ...
    model = GestureModel(model_type = args.model,model_size=args.size,learning_rate=args.lr,batch_size=args.batch_size,
