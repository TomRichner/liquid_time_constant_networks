...
class OzoneData:
    ...
    def __init__(self,seq_len=32):
        ...
        # cut_in_sequences returns (seq_len, num_seqs, features) — already time-major
        # Original code had a redundant np.stack here that transposed to (num_seqs, seq_len, features)
        # causing shape[1] to return seq_len (32) instead of num_seqs (625)
        self.train_x, self.train_y = cut_in_sequences(x, y, seq_len, inc=4)
...
class OzoneModel:
    ...
    def __init__(self,model_type,model_size,sparsity_level=0.0,learning_rate = 0.001,batch_size=16,same_lr_ltc=False,ltc_lr_for_srnn=False):
...
if __name__ == "__main__":
    ...
    model = OzoneModel(model_type = args.model,model_size=args.size,sparsity_level=args.sparsity,learning_rate=args.lr,batch_size=args.batch_size,same_lr_ltc=args.same_lr_ltc,ltc_lr_for_srnn=args.ltc_lr_for_srnn)
